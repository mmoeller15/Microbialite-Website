...
CREATE TABLE IF NOT EXISTS  AnalyzingMacrostructure (
    ...
    RockID INTEGER REFERENCES Macrostructure(MacrostructureID) ON UPDATE CASCADE ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS  AnalyzingMesostructure (
    ResearcherID INTEGER REFERENCES Employee(EmployeeID) ON UPDATE CASCADE ON DELETE CASCADE,
    RockID INTEGER REFERENCES Mesostructure(MesostructureID) ON UPDATE CASCADE ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS  AnalyzingThinSection (
    ResearcherID INTEGER REFERENCES Employee(EmployeeID) ON UPDATE CASCADE ON DELETE CASCADE,
    RockID INTEGER REFERENCES ThinSection(ThinSectionID) ON UPDATE CASCADE ON DELETE CASCADE
);
